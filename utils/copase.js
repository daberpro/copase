...
/**
 * @description membuat class dari tag html dan mengubah menjadi data yang di butuhkan
 * 
...
/**
 * @description membuat data mentah menjadi data setengah matang
 * 
 * @param {splitedValue return} dataSplited 
 * @returns 
 */
function checkValue(dataSplited,uuid){
	...
	if(result){
		...
		return {
			...
			property: dataSplited.copyOfPureClass,
			uuid: uuid,
